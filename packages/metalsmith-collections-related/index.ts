    ...
    Object.keys(collections).forEach((collection) => {
      ...
      collectionFiles.forEach((filename) => {
        ...
        const documentFilenames = [
          filename,
          ...collectionFiles.filter((relatedFilename) => relatedFilename !== filename),
        ];
        ...
        (files[filename].related as { [key: string]: Metalsmith.File[] })[collection] =
          relatedFiles;
      });
    });
